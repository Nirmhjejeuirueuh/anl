@echo off
REM Add books to Strapi using curl
REM Run this in Command Prompt or PowerShell

echo Adding Book 1: The Art of Cyber Resilience...
...
echo Adding Book 2: Outsmart the Insider...
...
echo Book 2 added!
echo.
echo Done! Check your Strapi admin panel at http://localhost:1337/admin
echo Go to Content Manager -^> Book to see and publish the books.
pause