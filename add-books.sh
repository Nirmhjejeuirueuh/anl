# Simple curl commands to add books to Strapi
# Run these commands one by one in your terminal

# Book 1: The Art of Cyber Resilience
...
echo "Book 2 created!"
echo "Done! Check your Strapi admin panel for the books."